...
<div class="container">
	<h2>Profile</h2>
	<form method="post" id="profile-form" action="{{ route('user.profile.store') }}" enctype="multipart/form-data">
		@csrf
			...
			<div class="card shadow">
				...
				<div class="card-body">
					...
					<div class="text-center">
						...
						<a class="btn btn-default" href="{{ route('user.dashboard') }}">Cancel</a>
					</div>
				</div>
			</div>
		</div>
